...
import type { Event, Nostr, VerifiedEvent } from '../core'
import { type Filter } from '../core/filter'
import { alwaysTrue } from '../utils/helpers'
...
export class AbstractSimplePool {
  ...
  private verifyEvent: (event: Event) => event is VerifiedEvent

  constructor(opts: AbstractPoolConstructorOptions) {
    this.verifyEvent = opts.verifyEvent as (event: Event) => event is VerifiedEvent
