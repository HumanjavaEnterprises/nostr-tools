import { EventTemplate, UnsignedEvent, NostrEvent } from '../core'
import { getConversationKey } from '../types/nips'
import { encrypt, decrypt as decryptNip44 } from './nip44'
import { getEventHash, generateSecretKey, finalizeEvent, getPublicKey } from '../core/pure'
import { Seal, GiftWrap } from '../types/kinds'
...
const nip44Decrypt = (data: NostrEvent, privateKey: Uint8Array) =>
  JSON.parse(decryptNip44(data.content, nip44ConversationKey(privateKey, data.pubkey)))
