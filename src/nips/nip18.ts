import { Event, finalizeEvent, verifyEvent } from '../core/pure'
import { Repost } from '../types/kinds'
import { decode as decodeNip19 } from './nip19'
import type { EventPointer } from '../types/nips'
