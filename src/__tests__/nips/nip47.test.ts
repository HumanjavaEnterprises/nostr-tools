...
import { makeNwcRequestEvent, parseConnectionString } from '../../nips/nip47'
import { decrypt } from '../../nips/nip04'
import { NWCWalletRequest } from '../../types/kinds'

describe('parseConnectionString', () => {
  it('returns pubkey, relay, and secret if connection string is valid', () => {
  ...
  it('throws an error if no pubkey in connection string', async () => {
    const connectionString =
  ...
  it('throws an error if no relay in connection string', async () => {
    const connectionString =
  ...
  it('throws an error if no secret in connection string', async () => {
    const connectionString =
...
describe('makeNwcRequestEvent', () => {
  it('returns a valid NWC request event', async () => {
