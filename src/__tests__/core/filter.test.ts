import { describe, test, expect, it } from '../helpers/test-utils'
import { getFilterLimit, matchFilter, matchFilters, mergeFilters } from '../../core/filter'
...
describe('Filter', () => {
  ...
  describe('getFilterLimit', () => {
    ...
    it('should count the authors times replaceable kinds', () => {
    ...
    it('should handle parameterized replaceable events', () => {
      ...
      expect(
        getFilterLimit({ kinds: [30078], authors: ['alex', 'fiatjaf'], '#d': ['ditto', 'soapbox'] }),
      ).toEqual(4)
      expect(
    ...
    it('should return Infinity for authors with regular kinds', () => {
      expect(getFilterLimit({ kinds: [1], authors: ['alex'] })).toEqual(Infinity)
    })

    it('should return Infinity for empty filters', () => {
      expect(getFilterLimit({})).toEqual(Infinity)
    })

    it('empty tags return 0', () => {
