...
import { ClassifiedListing, DraftClassifiedListing } from '../../types/kinds'
import { ClassifiedListingObject, generateEventTemplate, parseEvent, validateEvent } from '../../nips/nip99'
import { finalizeEvent, generateSecretKey } from '../../core/pure'

describe('validateEvent', () => {
  it('should return true for a valid classified listing event', () => {
  ...
  it('should return false when the "d" tag is missing', () => {
    const sk = generateSecretKey()
    const event: Event = finalizeEvent(
      {
        created_at: Math.floor(Date.now() / 1000),
  ...
  it('should return false when the "title" tag is missing', () => {
    const sk = generateSecretKey()
    const event: Event = finalizeEvent(
      {
        created_at: Math.floor(Date.now() / 1000),
  ...
  it('should return false when the "summary" tag is missing', () => {
    const sk = generateSecretKey()
    const event: Event = finalizeEvent(
      {
        created_at: Math.floor(Date.now() / 1000),
  ...
  it('should return false when the "published_at" tag is missing', () => {
    const sk = generateSecretKey()
    const event: Event = finalizeEvent(
      {
        created_at: Math.floor(Date.now() / 1000),
  ...
  it('should return false when the "location" tag is missing', () => {
    const sk = generateSecretKey()
    const event: Event = finalizeEvent(
      {
        created_at: Math.floor(Date.now() / 1000),
  ...
  it('should return false when the "price" tag is missing', () => {
    const sk = generateSecretKey()
    const event: Event = finalizeEvent(
      {
        created_at: Math.floor(Date.now() / 1000),
  ...
  it('should return false when the "published_at" tag is not a valid timestamp', () => {
    const sk = generateSecretKey()
    const event: Event = finalizeEvent(
      {
        created_at: Math.floor(Date.now() / 1000),
  ...
  it('should return false when the "price" tag has not a valid price', () => {
    const sk = generateSecretKey()
    const event: Event = finalizeEvent(
      {
        created_at: Math.floor(Date.now() / 1000),
  ...
  it('should return false when the "price" tag has not a valid currency', () => {
    const sk = generateSecretKey()
    const event: Event = finalizeEvent(
      {
        created_at: Math.floor(Date.now() / 1000),
  ...
  it('should return false when the "price" tag has not a valid number of elements', () => {
    const sk = generateSecretKey()
  ...
  it('should return false when the "a" tag has not a valid number of elements', () => {
    const sk = generateSecretKey()
    const event1: Event = finalizeEvent(
      {
        created_at: Math.floor(Date.now() / 1000),
...
describe('generateEventTemplate', () => {
  it('should generate the correct event template for a classified listing', () => {
